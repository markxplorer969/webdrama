...
if (!admin.apps.length) {
  try {
    // Initialize Firebase Admin with hardcoded values
    const serviceAccount = {
      type: "service_account",
      project_id: "dramaflex-38877",
      private_key_id: "2631ee595bc146a6b060eeb9ea6e9773b0467d80",
      ...
      client_email: "firebase-adminsdk-fbsvc@dramaflex-38877.iam.gserviceaccount.com",
